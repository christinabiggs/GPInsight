...
df_seq1 <- data.frame(value = seq(from=100, to= 20000, by= 100))
df_seq2 <- data.frame(value = seq(from=22000, to= 380000, by= 200))
df_seq3 <- data.frame(value = seq(from=400000, to= 800000, by= 300))
